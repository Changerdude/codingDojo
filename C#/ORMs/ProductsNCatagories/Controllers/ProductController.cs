...
public class ProductController : Controller
{
    ...
    {
        Product? ProductLookup = _context.Products.Include(p => p.ProdCatRelations).ThenInclude(r => r.Catagory).FirstOrDefault(p => p.ProductId == ProductId);
    ...
    {
        if(ViewModel.Relation.CatagoryId == 0)
        {
